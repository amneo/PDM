...
<?php } ?>
<?php if ($approval_details_list->TotalRecs > 0 && (!$approval_details_list->AutoHidePageSizeSelector || $approval_details_list->Pager->Visible)) { ?>
<div class="ew-pager">
<input type="hidden" name="t" value="approval_details">
<select name="<?php echo TABLE_REC_PER_PAGE ?>" class="form-control form-control-sm ew-tooltip" title="<?php echo $Language->phrase("RecordsPerPage") ?>" onchange="this.form.submit();">
<option value="50"<?php if ($approval_details_list->DisplayRecs == 50) { ?> selected<?php } ?>>50</option>
<option value="100"<?php if ($approval_details_list->DisplayRecs == 100) { ?> selected<?php } ?>>100</option>
<option value="150"<?php if ($approval_details_list->DisplayRecs == 150) { ?> selected<?php } ?>>150</option>
<option value="ALL"<?php if ($approval_details->getRecordsPerPage() == -1) { ?> selected<?php } ?>><?php echo $Language->Phrase("AllRecords") ?></option>
</select>
</div>
<?php } ?>
</form>
