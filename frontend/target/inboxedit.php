...
var finboxedit = currentForm = new ew.Form("finboxedit", "edit");

// Validate form
finboxedit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($inbox_edit->from->Required) { ?>
		...
		<?php } ?>
		<?php if ($inbox_edit->project_name->Required) { ?>
		...
		<?php } ?>
		<?php if ($inbox_edit->client_send_to->Required) { ?>
		...
		<?php } ?>
		<?php if ($inbox_edit->mode_send->Required) { ?>
		...
		<?php } ?>
		<?php if ($inbox_edit->native_file_link->Required) { ?>
...
finboxedit.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
finboxedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php $inbox_edit->showPageHeader(); ?>
<?php
$inbox_edit->showMessage();
?>
<form name="finboxedit" id="finboxedit" class="<?php echo $inbox_edit->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($inbox_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $inbox_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="inbox">
<input type="hidden" name="action" id="action" value="update">
<input type="hidden" name="modal" value="<?php echo (int)$inbox_edit->IsModal ?>">
<?php if (!$inbox_edit->IsMobileOrModal) { ?>
<div class="ew-desktop"><!-- desktop -->
<?php } ?>
<?php if ($inbox_edit->IsMobileOrModal) { ?>
<div class="ew-edit-div"><!-- page* -->
<?php } else { ?>
<table id="tbl_inboxedit" class="table table-striped table-sm ew-desktop-table"><!-- table* -->
<?php } ?>
<?php if ($inbox->from->Visible) { // from ?>
<?php if ($inbox_edit->IsMobileOrModal) { ?>
	<div id="r_from" class="form-group row">
		<label id="elh_inbox_from" for="x_from" class="<?php echo $inbox_edit->LeftColumnClass ?>"><?php echo $inbox->from->caption() ?><?php echo ($inbox->from->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $inbox_edit->RightColumnClass ?>"><div<?php echo $inbox->from->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_from">
		<td class="<?php echo $inbox_edit->TableLeftColumnClass ?>"><span id="elh_inbox_from"><?php echo $inbox->from->caption() ?><?php echo ($inbox->from->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($inbox_edit->IsMobileOrModal) { ?>
	<div id="r_project_name" class="form-group row">
		<label id="elh_inbox_project_name" for="x_project_name" class="<?php echo $inbox_edit->LeftColumnClass ?>"><?php echo $inbox->project_name->caption() ?><?php echo ($inbox->project_name->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $inbox_edit->RightColumnClass ?>"><div<?php echo $inbox->project_name->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_project_name">
		<td class="<?php echo $inbox_edit->TableLeftColumnClass ?>"><span id="elh_inbox_project_name"><?php echo $inbox->project_name->caption() ?><?php echo ($inbox->project_name->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($inbox_edit->IsMobileOrModal) { ?>
	<div id="r_client_send_to" class="form-group row">
		<label id="elh_inbox_client_send_to" for="x_client_send_to" class="<?php echo $inbox_edit->LeftColumnClass ?>"><?php echo $inbox->client_send_to->caption() ?><?php echo ($inbox->client_send_to->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $inbox_edit->RightColumnClass ?>"><div<?php echo $inbox->client_send_to->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_client_send_to">
		<td class="<?php echo $inbox_edit->TableLeftColumnClass ?>"><span id="elh_inbox_client_send_to"><?php echo $inbox->client_send_to->caption() ?><?php echo ($inbox->client_send_to->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($inbox_edit->IsMobileOrModal) { ?>
	<div id="r_mode_send" class="form-group row">
		<label id="elh_inbox_mode_send" for="x_mode_send" class="<?php echo $inbox_edit->LeftColumnClass ?>"><?php echo $inbox->mode_send->caption() ?><?php echo ($inbox->mode_send->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $inbox_edit->RightColumnClass ?>"><div<?php echo $inbox->mode_send->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_mode_send">
		<td class="<?php echo $inbox_edit->TableLeftColumnClass ?>"><span id="elh_inbox_mode_send"><?php echo $inbox->mode_send->caption() ?><?php echo ($inbox->mode_send->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($inbox_edit->IsMobileOrModal) { ?>
	<div id="r_remarks" class="form-group row">
		<label id="elh_inbox_remarks" for="x_remarks" class="<?php echo $inbox_edit->LeftColumnClass ?>"><?php echo $inbox->remarks->caption() ?><?php echo ($inbox->remarks->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $inbox_edit->RightColumnClass ?>"><div<?php echo $inbox->remarks->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_remarks">
		<td class="<?php echo $inbox_edit->TableLeftColumnClass ?>"><span id="elh_inbox_remarks"><?php echo $inbox->remarks->caption() ?><?php echo ($inbox->remarks->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($inbox_edit->IsMobileOrModal) { ?>
	<div id="r_document_link" class="form-group row">
		<label id="elh_inbox_document_link" class="<?php echo $inbox_edit->LeftColumnClass ?>"><?php echo $inbox->document_link->caption() ?><?php echo ($inbox->document_link->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $inbox_edit->RightColumnClass ?>"><div<?php echo $inbox->document_link->cellAttributes() ?>>
...
<?php if (Post("fa_x_document_link") == "0") { ?>
<input type="hidden" name="fa_x_document_link" id= "fa_x_document_link" value="0">
<?php } else { ?>
<input type="hidden" name="fa_x_document_link" id= "fa_x_document_link" value="1">
<?php } ?>
...
<?php } else { ?>
	<tr id="r_document_link">
		<td class="<?php echo $inbox_edit->TableLeftColumnClass ?>"><span id="elh_inbox_document_link"><?php echo $inbox->document_link->caption() ?><?php echo ($inbox->document_link->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($inbox_edit->IsMobileOrModal) { ?>
	<div id="r_native_file_link" class="form-group row">
		<label id="elh_inbox_native_file_link" for="x_native_file_link" class="<?php echo $inbox_edit->LeftColumnClass ?>"><?php echo $inbox->native_file_link->caption() ?><?php echo ($inbox->native_file_link->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $inbox_edit->RightColumnClass ?>"><div<?php echo $inbox->native_file_link->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_native_file_link">
		<td class="<?php echo $inbox_edit->TableLeftColumnClass ?>"><span id="elh_inbox_native_file_link"><?php echo $inbox->native_file_link->caption() ?><?php echo ($inbox->native_file_link->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php } ?>
	<input type="hidden" data-table="inbox" data-field="x_inbox_id" name="x_inbox_id" id="x_inbox_id" value="<?php echo HtmlEncode($inbox->inbox_id->CurrentValue) ?>">
<?php if (!$inbox_edit->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $inbox_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->phrase("SaveBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $inbox_edit->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
