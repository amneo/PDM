...
fdocument_logadd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php } ?>
		<?php if ($document_log_add->direction_out_file_sub1->Required) { ?>
...
<?php if ($document_log_add->IsMobileOrModal) { ?>
	<div id="r_direction_out_file_sub1" class="form-group row">
		<label id="elh_document_log_direction_out_file_sub1" for="x_direction_out_file_sub1" class="<?php echo $document_log_add->LeftColumnClass ?>"><?php echo $document_log->direction_out_file_sub1->caption() ?><?php echo ($document_log->direction_out_file_sub1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_add->RightColumnClass ?>"><div<?php echo $document_log->direction_out_file_sub1->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_direction_out_file_sub1">
		<td class="<?php echo $document_log_add->TableLeftColumnClass ?>"><span id="elh_document_log_direction_out_file_sub1"><?php echo $document_log->direction_out_file_sub1->caption() ?><?php echo ($document_log->direction_out_file_sub1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
