...
<input type="hidden" data-table="project_details" data-field="x_project_name" data-page="1" name="x_project_name" id="x_project_name" value="<?php echo HtmlEncode($project_details->project_name->CurrentValue) ?>">
...
<input type="hidden" data-table="project_details" data-field="x_project_our_client" data-page="1" name="x_project_our_client" id="x_project_our_client" value="<?php echo HtmlEncode($project_details->project_our_client->CurrentValue) ?>">
...
<input type="hidden" data-table="project_details" data-field="x_project_end_user" data-page="1" name="x_project_end_user" id="x_project_end_user" value="<?php echo HtmlEncode($project_details->project_end_user->CurrentValue) ?>">
