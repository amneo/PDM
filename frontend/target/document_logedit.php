...
fdocument_logedit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php } ?>
		<?php if ($document_log_edit->submit_no_sub1->Required) { ?>
		...
		<?php } ?>
		<?php if ($document_log_edit->revision_no_sub1->Required) { ?>
		...
		<?php } ?>
		<?php if ($document_log_edit->direction_out_sub1->Required) { ?>
		...
		<?php } ?>
		<?php if ($document_log_edit->planned_date_out_sub1->Required) { ?>
		...
		<?php if ($document_log_edit->transmit_date_out_sub1->Required) { ?>
		...
		<?php if ($document_log_edit->transmit_no_out_sub1->Required) { ?>
		...
		<?php } ?>
		<?php if ($document_log_edit->approval_status_out_sub1->Required) { ?>
		...
		<?php } ?>
		<?php if ($document_log_edit->transmit_no_in_sub1->Required) { ?>
		...
		<?php } ?>
		<?php if ($document_log_edit->approval_status_in_sub1->Required) { ?>
		...
		<?php } ?>
		<?php if ($document_log_edit->transmit_date_in_sub1->Required) { ?>
		...
		<?php if ($document_log_edit->submit_no_sub2->Required) { ?>
		...
		<?php } ?>
		<?php if ($document_log_edit->revision_no_sub2->Required) { ?>
		...
		<?php } ?>
		<?php if ($document_log_edit->direction_out_sub2->Required) { ?>
		...
		<?php } ?>
		<?php if ($document_log_edit->planned_date_out_sub2->Required) { ?>
		...
		<?php if ($document_log_edit->transmit_date_out_sub2->Required) { ?>
		...
		<?php if ($document_log_edit->transmit_no_out_sub2->Required) { ?>
		...
		<?php } ?>
		<?php if ($document_log_edit->approval_status_out_sub2->Required) { ?>
		...
		<?php } ?>
		<?php if ($document_log_edit->direction_in_sub2->Required) { ?>
		...
		<?php } ?>
		<?php if ($document_log_edit->transmit_no_in_sub2->Required) { ?>
		...
		<?php } ?>
		<?php if ($document_log_edit->approval_status_in_sub2->Required) { ?>
		...
		<?php } ?>
		<?php if ($document_log_edit->transmit_date_in_sub2->Required) { ?>
		...
		<?php if ($document_log_edit->submit_no_sub3->Required) { ?>
		...
		<?php } ?>
		<?php if ($document_log_edit->revision_no_sub3->Required) { ?>
		...
		<?php } ?>
		<?php if ($document_log_edit->direction_out_sub3->Required) { ?>
		...
		<?php } ?>
		<?php if ($document_log_edit->planned_date_out_sub3->Required) { ?>
		...
		<?php if ($document_log_edit->transmit_date_out_sub3->Required) { ?>
		...
		<?php if ($document_log_edit->transmit_no_out_sub3->Required) { ?>
		...
		<?php } ?>
		<?php if ($document_log_edit->approval_status_out_sub3->Required) { ?>
		...
		<?php } ?>
		<?php if ($document_log_edit->direction_in_sub3->Required) { ?>
		...
		<?php } ?>
		<?php if ($document_log_edit->transmit_no_in_sub3->Required) { ?>
		...
		<?php } ?>
		<?php if ($document_log_edit->approval_status_in_sub3->Required) { ?>
		...
		<?php } ?>
		<?php if ($document_log_edit->transmit_date_in_sub3->Required) { ?>
		...
		<?php if ($document_log_edit->submit_no_sub4->Required) { ?>
		...
		<?php } ?>
		<?php if ($document_log_edit->revision_no_sub4->Required) { ?>
		...
		<?php } ?>
		<?php if ($document_log_edit->direction_out_sub4->Required) { ?>
		...
		<?php } ?>
		<?php if ($document_log_edit->planned_date_out_sub4->Required) { ?>
		...
		<?php if ($document_log_edit->transmit_date_out_sub4->Required) { ?>
		...
		<?php if ($document_log_edit->transmit_no_out_sub4->Required) { ?>
		...
		<?php } ?>
		<?php if ($document_log_edit->approval_status_out_sub4->Required) { ?>
		...
		<?php } ?>
		<?php if ($document_log_edit->direction_in_sub4->Required) { ?>
		...
		<?php } ?>
		<?php if ($document_log_edit->transmit_no_in_sub4->Required) { ?>
		...
		<?php } ?>
		<?php if ($document_log_edit->approval_status_in_sub4->Required) { ?>
		...
		<?php } ?>
		<?php if ($document_log_edit->direction_in_file_sub4->Required) { ?>
		...
		<?php } ?>
		<?php if ($document_log_edit->transmit_date_in_sub4->Required) { ?>
		...
		<?php if ($document_log_edit->submit_no_sub5->Required) { ?>
		...
		<?php } ?>
		<?php if ($document_log_edit->revision_no_sub5->Required) { ?>
		...
		<?php } ?>
		<?php if ($document_log_edit->direction_out_sub5->Required) { ?>
		...
		<?php } ?>
		<?php if ($document_log_edit->planned_date_out_sub5->Required) { ?>
		...
		<?php if ($document_log_edit->transmit_date_out_sub5->Required) { ?>
		...
		<?php if ($document_log_edit->transmit_no_out_sub5->Required) { ?>
		...
		<?php } ?>
		<?php if ($document_log_edit->approval_status_out_sub5->Required) { ?>
		...
		<?php } ?>
		<?php if ($document_log_edit->direction_in_sub5->Required) { ?>
		...
		<?php } ?>
		<?php if ($document_log_edit->transmit_no_in_sub5->Required) { ?>
		...
		<?php } ?>
		<?php if ($document_log_edit->approval_status_in_sub5->Required) { ?>
		...
		<?php } ?>
		<?php if ($document_log_edit->direction_in_file_sub5->Required) { ?>
		...
		<?php } ?>
		<?php if ($document_log_edit->transmit_date_in_sub5->Required) { ?>
		...
		<?php if ($document_log_edit->submit_no_sub6->Required) { ?>
		...
		<?php } ?>
		<?php if ($document_log_edit->revision_no_sub6->Required) { ?>
		...
		<?php } ?>
		<?php if ($document_log_edit->direction_out_sub6->Required) { ?>
		...
		<?php } ?>
		<?php if ($document_log_edit->planned_date_out_sub6->Required) { ?>
		...
		<?php if ($document_log_edit->transmit_date_out_sub6->Required) { ?>
		...
		<?php if ($document_log_edit->transmit_no_out_sub6->Required) { ?>
		...
		<?php } ?>
		<?php if ($document_log_edit->approval_status_out_sub6->Required) { ?>
		...
		<?php } ?>
		<?php if ($document_log_edit->direction_in_sub6->Required) { ?>
		...
		<?php } ?>
		<?php if ($document_log_edit->transmit_no_in_sub6->Required) { ?>
		...
		<?php } ?>
		<?php if ($document_log_edit->approval_status_in_sub6->Required) { ?>
		...
		<?php } ?>
		<?php if ($document_log_edit->direction_in_file_sub6->Required) { ?>
		...
		<?php } ?>
		<?php if ($document_log_edit->transmit_date_in_sub6->Required) { ?>
		...
		<?php if ($document_log_edit->submit_no_sub7->Required) { ?>
		...
		<?php } ?>
		<?php if ($document_log_edit->revision_no_sub7->Required) { ?>
		...
		<?php } ?>
		<?php if ($document_log_edit->direction_out_sub7->Required) { ?>
		...
		<?php } ?>
		<?php if ($document_log_edit->planned_date_out_sub7->Required) { ?>
		...
		<?php if ($document_log_edit->transmit_date_out_sub7->Required) { ?>
		...
		<?php if ($document_log_edit->transmit_no_out_sub7->Required) { ?>
		...
		<?php } ?>
		<?php if ($document_log_edit->approval_status_out_sub7->Required) { ?>
		...
		<?php } ?>
		<?php if ($document_log_edit->direction_in_sub7->Required) { ?>
		...
		<?php } ?>
		<?php if ($document_log_edit->transmit_no_in_sub7->Required) { ?>
		...
		<?php } ?>
		<?php if ($document_log_edit->approval_status_in_sub7->Required) { ?>
		...
		<?php } ?>
		<?php if ($document_log_edit->transmit_date_in_sub7->Required) { ?>
		...
		<?php if ($document_log_edit->submit_no_sub8->Required) { ?>
		...
		<?php } ?>
		<?php if ($document_log_edit->revision_no_sub8->Required) { ?>
		...
		<?php } ?>
		<?php if ($document_log_edit->direction_out_sub8->Required) { ?>
		...
		<?php } ?>
		<?php if ($document_log_edit->planned_date_out_sub8->Required) { ?>
		...
		<?php if ($document_log_edit->transmit_date_out_sub8->Required) { ?>
		...
		<?php if ($document_log_edit->transmit_no_out_sub8->Required) { ?>
		...
		<?php } ?>
		<?php if ($document_log_edit->approval_status_out_sub8->Required) { ?>
		...
		<?php } ?>
		<?php if ($document_log_edit->direction_out_file_sub8->Required) { ?>
		...
		<?php } ?>
		<?php if ($document_log_edit->direction_in_sub8->Required) { ?>
		...
		<?php } ?>
		<?php if ($document_log_edit->transmit_no_in_sub8->Required) { ?>
		...
		<?php } ?>
		<?php if ($document_log_edit->approval_status_in_sub8->Required) { ?>
		...
		<?php } ?>
		<?php if ($document_log_edit->transmit_date_in_sub8->Required) { ?>
		...
		<?php if ($document_log_edit->submit_no_sub9->Required) { ?>
		...
		<?php } ?>
		<?php if ($document_log_edit->revision_no_sub9->Required) { ?>
		...
		<?php } ?>
		<?php if ($document_log_edit->direction_out_sub9->Required) { ?>
		...
		<?php } ?>
		<?php if ($document_log_edit->planned_date_out_sub9->Required) { ?>
		...
		<?php if ($document_log_edit->transmit_date_out_sub9->Required) { ?>
		...
		<?php if ($document_log_edit->transmit_no_out_sub9->Required) { ?>
		...
		<?php } ?>
		<?php if ($document_log_edit->approval_status_out_sub9->Required) { ?>
		...
		<?php } ?>
		<?php if ($document_log_edit->direction_in_sub9->Required) { ?>
		...
		<?php } ?>
		<?php if ($document_log_edit->transmit_no_in_sub9->Required) { ?>
		...
		<?php } ?>
		<?php if ($document_log_edit->approval_status_in_sub9->Required) { ?>
		...
		<?php } ?>
		<?php if ($document_log_edit->transmit_date_in_sub9->Required) { ?>
		...
		<?php if ($document_log_edit->submit_no_sub10->Required) { ?>
		...
		<?php } ?>
		<?php if ($document_log_edit->revision_no_sub10->Required) { ?>
		...
		<?php } ?>
		<?php if ($document_log_edit->direction_out_sub10->Required) { ?>
		...
		<?php } ?>
		<?php if ($document_log_edit->planned_date_out_sub10->Required) { ?>
		...
		<?php if ($document_log_edit->transmit_date_out_sub10->Required) { ?>
		...
		<?php if ($document_log_edit->transmit_no_out_sub10->Required) { ?>
		...
		<?php } ?>
		<?php if ($document_log_edit->approval_status_out_sub10->Required) { ?>
		...
		<?php } ?>
		<?php if ($document_log_edit->direction_in_sub10->Required) { ?>
		...
		<?php } ?>
		<?php if ($document_log_edit->transmit_no_in_sub10->Required) { ?>
		...
		<?php } ?>
		<?php if ($document_log_edit->approval_status_in_sub10->Required) { ?>
		...
		<?php } ?>
		<?php if ($document_log_edit->transmit_date_in_sub10->Required) { ?>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_submit_no_sub1" class="form-group row">
		<label id="elh_document_log_submit_no_sub1" for="x_submit_no_sub1" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->submit_no_sub1->caption() ?><?php echo ($document_log->submit_no_sub1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->submit_no_sub1->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_submit_no_sub1">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_submit_no_sub1"><?php echo $document_log->submit_no_sub1->caption() ?><?php echo ($document_log->submit_no_sub1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_revision_no_sub1" class="form-group row">
		<label id="elh_document_log_revision_no_sub1" for="x_revision_no_sub1" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->revision_no_sub1->caption() ?><?php echo ($document_log->revision_no_sub1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->revision_no_sub1->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_revision_no_sub1">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_revision_no_sub1"><?php echo $document_log->revision_no_sub1->caption() ?><?php echo ($document_log->revision_no_sub1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_direction_out_sub1" class="form-group row">
		<label id="elh_document_log_direction_out_sub1" for="x_direction_out_sub1" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->direction_out_sub1->caption() ?><?php echo ($document_log->direction_out_sub1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->direction_out_sub1->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_direction_out_sub1">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_direction_out_sub1"><?php echo $document_log->direction_out_sub1->caption() ?><?php echo ($document_log->direction_out_sub1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_planned_date_out_sub1" class="form-group row">
		<label id="elh_document_log_planned_date_out_sub1" for="x_planned_date_out_sub1" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->planned_date_out_sub1->caption() ?><?php echo ($document_log->planned_date_out_sub1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->planned_date_out_sub1->cellAttributes() ?>>
...
<script>
ew.createDateTimePicker("fdocument_logedit", "x_planned_date_out_sub1", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php } else { ?>
	<tr id="r_planned_date_out_sub1">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_planned_date_out_sub1"><?php echo $document_log->planned_date_out_sub1->caption() ?><?php echo ($document_log->planned_date_out_sub1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_transmit_date_out_sub1" class="form-group row">
		<label id="elh_document_log_transmit_date_out_sub1" for="x_transmit_date_out_sub1" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->transmit_date_out_sub1->caption() ?><?php echo ($document_log->transmit_date_out_sub1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->transmit_date_out_sub1->cellAttributes() ?>>
...
<script>
ew.createDateTimePicker("fdocument_logedit", "x_transmit_date_out_sub1", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php } else { ?>
	<tr id="r_transmit_date_out_sub1">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_transmit_date_out_sub1"><?php echo $document_log->transmit_date_out_sub1->caption() ?><?php echo ($document_log->transmit_date_out_sub1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_transmit_no_out_sub1" class="form-group row">
		<label id="elh_document_log_transmit_no_out_sub1" for="x_transmit_no_out_sub1" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->transmit_no_out_sub1->caption() ?><?php echo ($document_log->transmit_no_out_sub1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->transmit_no_out_sub1->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_transmit_no_out_sub1">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_transmit_no_out_sub1"><?php echo $document_log->transmit_no_out_sub1->caption() ?><?php echo ($document_log->transmit_no_out_sub1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_approval_status_out_sub1" class="form-group row">
		<label id="elh_document_log_approval_status_out_sub1" for="x_approval_status_out_sub1" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->approval_status_out_sub1->caption() ?><?php echo ($document_log->approval_status_out_sub1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->approval_status_out_sub1->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_approval_status_out_sub1">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_approval_status_out_sub1"><?php echo $document_log->approval_status_out_sub1->caption() ?><?php echo ($document_log->approval_status_out_sub1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_direction_in_sub1" class="form-group row">
		<label id="elh_document_log_direction_in_sub1" for="x_direction_in_sub1" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->direction_in_sub1->caption() ?><?php echo ($document_log->direction_in_sub1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->direction_in_sub1->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_direction_in_sub1">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_direction_in_sub1"><?php echo $document_log->direction_in_sub1->caption() ?><?php echo ($document_log->direction_in_sub1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_transmit_no_in_sub1" class="form-group row">
		<label id="elh_document_log_transmit_no_in_sub1" for="x_transmit_no_in_sub1" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->transmit_no_in_sub1->caption() ?><?php echo ($document_log->transmit_no_in_sub1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->transmit_no_in_sub1->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_transmit_no_in_sub1">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_transmit_no_in_sub1"><?php echo $document_log->transmit_no_in_sub1->caption() ?><?php echo ($document_log->transmit_no_in_sub1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_approval_status_in_sub1" class="form-group row">
		<label id="elh_document_log_approval_status_in_sub1" for="x_approval_status_in_sub1" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->approval_status_in_sub1->caption() ?><?php echo ($document_log->approval_status_in_sub1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->approval_status_in_sub1->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_approval_status_in_sub1">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_approval_status_in_sub1"><?php echo $document_log->approval_status_in_sub1->caption() ?><?php echo ($document_log->approval_status_in_sub1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_transmit_date_in_sub1" class="form-group row">
		<label id="elh_document_log_transmit_date_in_sub1" for="x_transmit_date_in_sub1" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->transmit_date_in_sub1->caption() ?><?php echo ($document_log->transmit_date_in_sub1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->transmit_date_in_sub1->cellAttributes() ?>>
...
<script>
ew.createDateTimePicker("fdocument_logedit", "x_transmit_date_in_sub1", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php } else { ?>
	<tr id="r_transmit_date_in_sub1">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_transmit_date_in_sub1"><?php echo $document_log->transmit_date_in_sub1->caption() ?><?php echo ($document_log->transmit_date_in_sub1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_submit_no_sub2" class="form-group row">
		<label id="elh_document_log_submit_no_sub2" for="x_submit_no_sub2" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->submit_no_sub2->caption() ?><?php echo ($document_log->submit_no_sub2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->submit_no_sub2->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_submit_no_sub2">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_submit_no_sub2"><?php echo $document_log->submit_no_sub2->caption() ?><?php echo ($document_log->submit_no_sub2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_revision_no_sub2" class="form-group row">
		<label id="elh_document_log_revision_no_sub2" for="x_revision_no_sub2" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->revision_no_sub2->caption() ?><?php echo ($document_log->revision_no_sub2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->revision_no_sub2->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_revision_no_sub2">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_revision_no_sub2"><?php echo $document_log->revision_no_sub2->caption() ?><?php echo ($document_log->revision_no_sub2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_direction_out_sub2" class="form-group row">
		<label id="elh_document_log_direction_out_sub2" for="x_direction_out_sub2" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->direction_out_sub2->caption() ?><?php echo ($document_log->direction_out_sub2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->direction_out_sub2->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_direction_out_sub2">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_direction_out_sub2"><?php echo $document_log->direction_out_sub2->caption() ?><?php echo ($document_log->direction_out_sub2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_planned_date_out_sub2" class="form-group row">
		<label id="elh_document_log_planned_date_out_sub2" for="x_planned_date_out_sub2" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->planned_date_out_sub2->caption() ?><?php echo ($document_log->planned_date_out_sub2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->planned_date_out_sub2->cellAttributes() ?>>
...
<script>
ew.createDateTimePicker("fdocument_logedit", "x_planned_date_out_sub2", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php } else { ?>
	<tr id="r_planned_date_out_sub2">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_planned_date_out_sub2"><?php echo $document_log->planned_date_out_sub2->caption() ?><?php echo ($document_log->planned_date_out_sub2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_transmit_date_out_sub2" class="form-group row">
		<label id="elh_document_log_transmit_date_out_sub2" for="x_transmit_date_out_sub2" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->transmit_date_out_sub2->caption() ?><?php echo ($document_log->transmit_date_out_sub2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->transmit_date_out_sub2->cellAttributes() ?>>
...
<script>
ew.createDateTimePicker("fdocument_logedit", "x_transmit_date_out_sub2", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php } else { ?>
	<tr id="r_transmit_date_out_sub2">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_transmit_date_out_sub2"><?php echo $document_log->transmit_date_out_sub2->caption() ?><?php echo ($document_log->transmit_date_out_sub2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_transmit_no_out_sub2" class="form-group row">
		<label id="elh_document_log_transmit_no_out_sub2" for="x_transmit_no_out_sub2" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->transmit_no_out_sub2->caption() ?><?php echo ($document_log->transmit_no_out_sub2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->transmit_no_out_sub2->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_transmit_no_out_sub2">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_transmit_no_out_sub2"><?php echo $document_log->transmit_no_out_sub2->caption() ?><?php echo ($document_log->transmit_no_out_sub2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_approval_status_out_sub2" class="form-group row">
		<label id="elh_document_log_approval_status_out_sub2" for="x_approval_status_out_sub2" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->approval_status_out_sub2->caption() ?><?php echo ($document_log->approval_status_out_sub2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->approval_status_out_sub2->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_approval_status_out_sub2">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_approval_status_out_sub2"><?php echo $document_log->approval_status_out_sub2->caption() ?><?php echo ($document_log->approval_status_out_sub2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_direction_in_sub2" class="form-group row">
		<label id="elh_document_log_direction_in_sub2" for="x_direction_in_sub2" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->direction_in_sub2->caption() ?><?php echo ($document_log->direction_in_sub2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->direction_in_sub2->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_direction_in_sub2">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_direction_in_sub2"><?php echo $document_log->direction_in_sub2->caption() ?><?php echo ($document_log->direction_in_sub2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_transmit_no_in_sub2" class="form-group row">
		<label id="elh_document_log_transmit_no_in_sub2" for="x_transmit_no_in_sub2" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->transmit_no_in_sub2->caption() ?><?php echo ($document_log->transmit_no_in_sub2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->transmit_no_in_sub2->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_transmit_no_in_sub2">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_transmit_no_in_sub2"><?php echo $document_log->transmit_no_in_sub2->caption() ?><?php echo ($document_log->transmit_no_in_sub2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_approval_status_in_sub2" class="form-group row">
		<label id="elh_document_log_approval_status_in_sub2" for="x_approval_status_in_sub2" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->approval_status_in_sub2->caption() ?><?php echo ($document_log->approval_status_in_sub2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->approval_status_in_sub2->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_approval_status_in_sub2">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_approval_status_in_sub2"><?php echo $document_log->approval_status_in_sub2->caption() ?><?php echo ($document_log->approval_status_in_sub2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_transmit_date_in_sub2" class="form-group row">
		<label id="elh_document_log_transmit_date_in_sub2" for="x_transmit_date_in_sub2" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->transmit_date_in_sub2->caption() ?><?php echo ($document_log->transmit_date_in_sub2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->transmit_date_in_sub2->cellAttributes() ?>>
...
<script>
ew.createDateTimePicker("fdocument_logedit", "x_transmit_date_in_sub2", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php } else { ?>
	<tr id="r_transmit_date_in_sub2">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_transmit_date_in_sub2"><?php echo $document_log->transmit_date_in_sub2->caption() ?><?php echo ($document_log->transmit_date_in_sub2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_submit_no_sub3" class="form-group row">
		<label id="elh_document_log_submit_no_sub3" for="x_submit_no_sub3" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->submit_no_sub3->caption() ?><?php echo ($document_log->submit_no_sub3->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->submit_no_sub3->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_submit_no_sub3">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_submit_no_sub3"><?php echo $document_log->submit_no_sub3->caption() ?><?php echo ($document_log->submit_no_sub3->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_revision_no_sub3" class="form-group row">
		<label id="elh_document_log_revision_no_sub3" for="x_revision_no_sub3" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->revision_no_sub3->caption() ?><?php echo ($document_log->revision_no_sub3->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->revision_no_sub3->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_revision_no_sub3">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_revision_no_sub3"><?php echo $document_log->revision_no_sub3->caption() ?><?php echo ($document_log->revision_no_sub3->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_direction_out_sub3" class="form-group row">
		<label id="elh_document_log_direction_out_sub3" for="x_direction_out_sub3" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->direction_out_sub3->caption() ?><?php echo ($document_log->direction_out_sub3->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->direction_out_sub3->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_direction_out_sub3">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_direction_out_sub3"><?php echo $document_log->direction_out_sub3->caption() ?><?php echo ($document_log->direction_out_sub3->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_planned_date_out_sub3" class="form-group row">
		<label id="elh_document_log_planned_date_out_sub3" for="x_planned_date_out_sub3" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->planned_date_out_sub3->caption() ?><?php echo ($document_log->planned_date_out_sub3->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->planned_date_out_sub3->cellAttributes() ?>>
...
<script>
ew.createDateTimePicker("fdocument_logedit", "x_planned_date_out_sub3", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php } else { ?>
	<tr id="r_planned_date_out_sub3">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_planned_date_out_sub3"><?php echo $document_log->planned_date_out_sub3->caption() ?><?php echo ($document_log->planned_date_out_sub3->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_transmit_date_out_sub3" class="form-group row">
		<label id="elh_document_log_transmit_date_out_sub3" for="x_transmit_date_out_sub3" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->transmit_date_out_sub3->caption() ?><?php echo ($document_log->transmit_date_out_sub3->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->transmit_date_out_sub3->cellAttributes() ?>>
...
<script>
ew.createDateTimePicker("fdocument_logedit", "x_transmit_date_out_sub3", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php } else { ?>
	<tr id="r_transmit_date_out_sub3">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_transmit_date_out_sub3"><?php echo $document_log->transmit_date_out_sub3->caption() ?><?php echo ($document_log->transmit_date_out_sub3->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_transmit_no_out_sub3" class="form-group row">
		<label id="elh_document_log_transmit_no_out_sub3" for="x_transmit_no_out_sub3" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->transmit_no_out_sub3->caption() ?><?php echo ($document_log->transmit_no_out_sub3->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->transmit_no_out_sub3->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_transmit_no_out_sub3">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_transmit_no_out_sub3"><?php echo $document_log->transmit_no_out_sub3->caption() ?><?php echo ($document_log->transmit_no_out_sub3->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_approval_status_out_sub3" class="form-group row">
		<label id="elh_document_log_approval_status_out_sub3" for="x_approval_status_out_sub3" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->approval_status_out_sub3->caption() ?><?php echo ($document_log->approval_status_out_sub3->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->approval_status_out_sub3->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_approval_status_out_sub3">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_approval_status_out_sub3"><?php echo $document_log->approval_status_out_sub3->caption() ?><?php echo ($document_log->approval_status_out_sub3->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_direction_in_sub3" class="form-group row">
		<label id="elh_document_log_direction_in_sub3" for="x_direction_in_sub3" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->direction_in_sub3->caption() ?><?php echo ($document_log->direction_in_sub3->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->direction_in_sub3->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_direction_in_sub3">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_direction_in_sub3"><?php echo $document_log->direction_in_sub3->caption() ?><?php echo ($document_log->direction_in_sub3->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_transmit_no_in_sub3" class="form-group row">
		<label id="elh_document_log_transmit_no_in_sub3" for="x_transmit_no_in_sub3" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->transmit_no_in_sub3->caption() ?><?php echo ($document_log->transmit_no_in_sub3->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->transmit_no_in_sub3->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_transmit_no_in_sub3">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_transmit_no_in_sub3"><?php echo $document_log->transmit_no_in_sub3->caption() ?><?php echo ($document_log->transmit_no_in_sub3->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_approval_status_in_sub3" class="form-group row">
		<label id="elh_document_log_approval_status_in_sub3" for="x_approval_status_in_sub3" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->approval_status_in_sub3->caption() ?><?php echo ($document_log->approval_status_in_sub3->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->approval_status_in_sub3->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_approval_status_in_sub3">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_approval_status_in_sub3"><?php echo $document_log->approval_status_in_sub3->caption() ?><?php echo ($document_log->approval_status_in_sub3->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_transmit_date_in_sub3" class="form-group row">
		<label id="elh_document_log_transmit_date_in_sub3" for="x_transmit_date_in_sub3" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->transmit_date_in_sub3->caption() ?><?php echo ($document_log->transmit_date_in_sub3->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->transmit_date_in_sub3->cellAttributes() ?>>
...
<script>
ew.createDateTimePicker("fdocument_logedit", "x_transmit_date_in_sub3", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php } else { ?>
	<tr id="r_transmit_date_in_sub3">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_transmit_date_in_sub3"><?php echo $document_log->transmit_date_in_sub3->caption() ?><?php echo ($document_log->transmit_date_in_sub3->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_submit_no_sub4" class="form-group row">
		<label id="elh_document_log_submit_no_sub4" for="x_submit_no_sub4" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->submit_no_sub4->caption() ?><?php echo ($document_log->submit_no_sub4->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->submit_no_sub4->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_submit_no_sub4">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_submit_no_sub4"><?php echo $document_log->submit_no_sub4->caption() ?><?php echo ($document_log->submit_no_sub4->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_revision_no_sub4" class="form-group row">
		<label id="elh_document_log_revision_no_sub4" for="x_revision_no_sub4" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->revision_no_sub4->caption() ?><?php echo ($document_log->revision_no_sub4->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->revision_no_sub4->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_revision_no_sub4">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_revision_no_sub4"><?php echo $document_log->revision_no_sub4->caption() ?><?php echo ($document_log->revision_no_sub4->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_direction_out_sub4" class="form-group row">
		<label id="elh_document_log_direction_out_sub4" for="x_direction_out_sub4" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->direction_out_sub4->caption() ?><?php echo ($document_log->direction_out_sub4->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->direction_out_sub4->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_direction_out_sub4">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_direction_out_sub4"><?php echo $document_log->direction_out_sub4->caption() ?><?php echo ($document_log->direction_out_sub4->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_planned_date_out_sub4" class="form-group row">
		<label id="elh_document_log_planned_date_out_sub4" for="x_planned_date_out_sub4" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->planned_date_out_sub4->caption() ?><?php echo ($document_log->planned_date_out_sub4->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->planned_date_out_sub4->cellAttributes() ?>>
...
<script>
ew.createDateTimePicker("fdocument_logedit", "x_planned_date_out_sub4", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php } else { ?>
	<tr id="r_planned_date_out_sub4">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_planned_date_out_sub4"><?php echo $document_log->planned_date_out_sub4->caption() ?><?php echo ($document_log->planned_date_out_sub4->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_transmit_date_out_sub4" class="form-group row">
		<label id="elh_document_log_transmit_date_out_sub4" for="x_transmit_date_out_sub4" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->transmit_date_out_sub4->caption() ?><?php echo ($document_log->transmit_date_out_sub4->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->transmit_date_out_sub4->cellAttributes() ?>>
...
<script>
ew.createDateTimePicker("fdocument_logedit", "x_transmit_date_out_sub4", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php } else { ?>
	<tr id="r_transmit_date_out_sub4">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_transmit_date_out_sub4"><?php echo $document_log->transmit_date_out_sub4->caption() ?><?php echo ($document_log->transmit_date_out_sub4->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_transmit_no_out_sub4" class="form-group row">
		<label id="elh_document_log_transmit_no_out_sub4" for="x_transmit_no_out_sub4" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->transmit_no_out_sub4->caption() ?><?php echo ($document_log->transmit_no_out_sub4->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->transmit_no_out_sub4->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_transmit_no_out_sub4">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_transmit_no_out_sub4"><?php echo $document_log->transmit_no_out_sub4->caption() ?><?php echo ($document_log->transmit_no_out_sub4->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_approval_status_out_sub4" class="form-group row">
		<label id="elh_document_log_approval_status_out_sub4" for="x_approval_status_out_sub4" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->approval_status_out_sub4->caption() ?><?php echo ($document_log->approval_status_out_sub4->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->approval_status_out_sub4->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_approval_status_out_sub4">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_approval_status_out_sub4"><?php echo $document_log->approval_status_out_sub4->caption() ?><?php echo ($document_log->approval_status_out_sub4->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_direction_in_sub4" class="form-group row">
		<label id="elh_document_log_direction_in_sub4" for="x_direction_in_sub4" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->direction_in_sub4->caption() ?><?php echo ($document_log->direction_in_sub4->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->direction_in_sub4->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_direction_in_sub4">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_direction_in_sub4"><?php echo $document_log->direction_in_sub4->caption() ?><?php echo ($document_log->direction_in_sub4->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_transmit_no_in_sub4" class="form-group row">
		<label id="elh_document_log_transmit_no_in_sub4" for="x_transmit_no_in_sub4" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->transmit_no_in_sub4->caption() ?><?php echo ($document_log->transmit_no_in_sub4->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->transmit_no_in_sub4->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_transmit_no_in_sub4">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_transmit_no_in_sub4"><?php echo $document_log->transmit_no_in_sub4->caption() ?><?php echo ($document_log->transmit_no_in_sub4->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_approval_status_in_sub4" class="form-group row">
		<label id="elh_document_log_approval_status_in_sub4" for="x_approval_status_in_sub4" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->approval_status_in_sub4->caption() ?><?php echo ($document_log->approval_status_in_sub4->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->approval_status_in_sub4->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_approval_status_in_sub4">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_approval_status_in_sub4"><?php echo $document_log->approval_status_in_sub4->caption() ?><?php echo ($document_log->approval_status_in_sub4->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_direction_in_file_sub4" class="form-group row">
		<label id="elh_document_log_direction_in_file_sub4" for="x_direction_in_file_sub4" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->direction_in_file_sub4->caption() ?><?php echo ($document_log->direction_in_file_sub4->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->direction_in_file_sub4->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_direction_in_file_sub4">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_direction_in_file_sub4"><?php echo $document_log->direction_in_file_sub4->caption() ?><?php echo ($document_log->direction_in_file_sub4->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_transmit_date_in_sub4" class="form-group row">
		<label id="elh_document_log_transmit_date_in_sub4" for="x_transmit_date_in_sub4" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->transmit_date_in_sub4->caption() ?><?php echo ($document_log->transmit_date_in_sub4->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->transmit_date_in_sub4->cellAttributes() ?>>
...
<script>
ew.createDateTimePicker("fdocument_logedit", "x_transmit_date_in_sub4", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php } else { ?>
	<tr id="r_transmit_date_in_sub4">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_transmit_date_in_sub4"><?php echo $document_log->transmit_date_in_sub4->caption() ?><?php echo ($document_log->transmit_date_in_sub4->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_submit_no_sub5" class="form-group row">
		<label id="elh_document_log_submit_no_sub5" for="x_submit_no_sub5" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->submit_no_sub5->caption() ?><?php echo ($document_log->submit_no_sub5->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->submit_no_sub5->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_submit_no_sub5">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_submit_no_sub5"><?php echo $document_log->submit_no_sub5->caption() ?><?php echo ($document_log->submit_no_sub5->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_revision_no_sub5" class="form-group row">
		<label id="elh_document_log_revision_no_sub5" for="x_revision_no_sub5" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->revision_no_sub5->caption() ?><?php echo ($document_log->revision_no_sub5->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->revision_no_sub5->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_revision_no_sub5">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_revision_no_sub5"><?php echo $document_log->revision_no_sub5->caption() ?><?php echo ($document_log->revision_no_sub5->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_direction_out_sub5" class="form-group row">
		<label id="elh_document_log_direction_out_sub5" for="x_direction_out_sub5" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->direction_out_sub5->caption() ?><?php echo ($document_log->direction_out_sub5->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->direction_out_sub5->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_direction_out_sub5">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_direction_out_sub5"><?php echo $document_log->direction_out_sub5->caption() ?><?php echo ($document_log->direction_out_sub5->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_planned_date_out_sub5" class="form-group row">
		<label id="elh_document_log_planned_date_out_sub5" for="x_planned_date_out_sub5" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->planned_date_out_sub5->caption() ?><?php echo ($document_log->planned_date_out_sub5->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->planned_date_out_sub5->cellAttributes() ?>>
...
<script>
ew.createDateTimePicker("fdocument_logedit", "x_planned_date_out_sub5", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php } else { ?>
	<tr id="r_planned_date_out_sub5">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_planned_date_out_sub5"><?php echo $document_log->planned_date_out_sub5->caption() ?><?php echo ($document_log->planned_date_out_sub5->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_transmit_date_out_sub5" class="form-group row">
		<label id="elh_document_log_transmit_date_out_sub5" for="x_transmit_date_out_sub5" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->transmit_date_out_sub5->caption() ?><?php echo ($document_log->transmit_date_out_sub5->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->transmit_date_out_sub5->cellAttributes() ?>>
...
<script>
ew.createDateTimePicker("fdocument_logedit", "x_transmit_date_out_sub5", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php } else { ?>
	<tr id="r_transmit_date_out_sub5">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_transmit_date_out_sub5"><?php echo $document_log->transmit_date_out_sub5->caption() ?><?php echo ($document_log->transmit_date_out_sub5->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_transmit_no_out_sub5" class="form-group row">
		<label id="elh_document_log_transmit_no_out_sub5" for="x_transmit_no_out_sub5" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->transmit_no_out_sub5->caption() ?><?php echo ($document_log->transmit_no_out_sub5->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->transmit_no_out_sub5->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_transmit_no_out_sub5">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_transmit_no_out_sub5"><?php echo $document_log->transmit_no_out_sub5->caption() ?><?php echo ($document_log->transmit_no_out_sub5->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_approval_status_out_sub5" class="form-group row">
		<label id="elh_document_log_approval_status_out_sub5" for="x_approval_status_out_sub5" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->approval_status_out_sub5->caption() ?><?php echo ($document_log->approval_status_out_sub5->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->approval_status_out_sub5->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_approval_status_out_sub5">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_approval_status_out_sub5"><?php echo $document_log->approval_status_out_sub5->caption() ?><?php echo ($document_log->approval_status_out_sub5->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_direction_in_sub5" class="form-group row">
		<label id="elh_document_log_direction_in_sub5" for="x_direction_in_sub5" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->direction_in_sub5->caption() ?><?php echo ($document_log->direction_in_sub5->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->direction_in_sub5->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_direction_in_sub5">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_direction_in_sub5"><?php echo $document_log->direction_in_sub5->caption() ?><?php echo ($document_log->direction_in_sub5->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_transmit_no_in_sub5" class="form-group row">
		<label id="elh_document_log_transmit_no_in_sub5" for="x_transmit_no_in_sub5" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->transmit_no_in_sub5->caption() ?><?php echo ($document_log->transmit_no_in_sub5->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->transmit_no_in_sub5->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_transmit_no_in_sub5">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_transmit_no_in_sub5"><?php echo $document_log->transmit_no_in_sub5->caption() ?><?php echo ($document_log->transmit_no_in_sub5->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_approval_status_in_sub5" class="form-group row">
		<label id="elh_document_log_approval_status_in_sub5" for="x_approval_status_in_sub5" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->approval_status_in_sub5->caption() ?><?php echo ($document_log->approval_status_in_sub5->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->approval_status_in_sub5->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_approval_status_in_sub5">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_approval_status_in_sub5"><?php echo $document_log->approval_status_in_sub5->caption() ?><?php echo ($document_log->approval_status_in_sub5->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_direction_in_file_sub5" class="form-group row">
		<label id="elh_document_log_direction_in_file_sub5" for="x_direction_in_file_sub5" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->direction_in_file_sub5->caption() ?><?php echo ($document_log->direction_in_file_sub5->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->direction_in_file_sub5->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_direction_in_file_sub5">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_direction_in_file_sub5"><?php echo $document_log->direction_in_file_sub5->caption() ?><?php echo ($document_log->direction_in_file_sub5->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_transmit_date_in_sub5" class="form-group row">
		<label id="elh_document_log_transmit_date_in_sub5" for="x_transmit_date_in_sub5" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->transmit_date_in_sub5->caption() ?><?php echo ($document_log->transmit_date_in_sub5->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->transmit_date_in_sub5->cellAttributes() ?>>
...
<script>
ew.createDateTimePicker("fdocument_logedit", "x_transmit_date_in_sub5", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php } else { ?>
	<tr id="r_transmit_date_in_sub5">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_transmit_date_in_sub5"><?php echo $document_log->transmit_date_in_sub5->caption() ?><?php echo ($document_log->transmit_date_in_sub5->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_submit_no_sub6" class="form-group row">
		<label id="elh_document_log_submit_no_sub6" for="x_submit_no_sub6" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->submit_no_sub6->caption() ?><?php echo ($document_log->submit_no_sub6->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->submit_no_sub6->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_submit_no_sub6">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_submit_no_sub6"><?php echo $document_log->submit_no_sub6->caption() ?><?php echo ($document_log->submit_no_sub6->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_revision_no_sub6" class="form-group row">
		<label id="elh_document_log_revision_no_sub6" for="x_revision_no_sub6" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->revision_no_sub6->caption() ?><?php echo ($document_log->revision_no_sub6->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->revision_no_sub6->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_revision_no_sub6">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_revision_no_sub6"><?php echo $document_log->revision_no_sub6->caption() ?><?php echo ($document_log->revision_no_sub6->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_direction_out_sub6" class="form-group row">
		<label id="elh_document_log_direction_out_sub6" for="x_direction_out_sub6" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->direction_out_sub6->caption() ?><?php echo ($document_log->direction_out_sub6->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->direction_out_sub6->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_direction_out_sub6">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_direction_out_sub6"><?php echo $document_log->direction_out_sub6->caption() ?><?php echo ($document_log->direction_out_sub6->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_planned_date_out_sub6" class="form-group row">
		<label id="elh_document_log_planned_date_out_sub6" for="x_planned_date_out_sub6" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->planned_date_out_sub6->caption() ?><?php echo ($document_log->planned_date_out_sub6->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->planned_date_out_sub6->cellAttributes() ?>>
...
<script>
ew.createDateTimePicker("fdocument_logedit", "x_planned_date_out_sub6", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php } else { ?>
	<tr id="r_planned_date_out_sub6">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_planned_date_out_sub6"><?php echo $document_log->planned_date_out_sub6->caption() ?><?php echo ($document_log->planned_date_out_sub6->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_transmit_date_out_sub6" class="form-group row">
		<label id="elh_document_log_transmit_date_out_sub6" for="x_transmit_date_out_sub6" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->transmit_date_out_sub6->caption() ?><?php echo ($document_log->transmit_date_out_sub6->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->transmit_date_out_sub6->cellAttributes() ?>>
...
<script>
ew.createDateTimePicker("fdocument_logedit", "x_transmit_date_out_sub6", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php } else { ?>
	<tr id="r_transmit_date_out_sub6">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_transmit_date_out_sub6"><?php echo $document_log->transmit_date_out_sub6->caption() ?><?php echo ($document_log->transmit_date_out_sub6->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_transmit_no_out_sub6" class="form-group row">
		<label id="elh_document_log_transmit_no_out_sub6" for="x_transmit_no_out_sub6" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->transmit_no_out_sub6->caption() ?><?php echo ($document_log->transmit_no_out_sub6->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->transmit_no_out_sub6->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_transmit_no_out_sub6">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_transmit_no_out_sub6"><?php echo $document_log->transmit_no_out_sub6->caption() ?><?php echo ($document_log->transmit_no_out_sub6->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_approval_status_out_sub6" class="form-group row">
		<label id="elh_document_log_approval_status_out_sub6" for="x_approval_status_out_sub6" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->approval_status_out_sub6->caption() ?><?php echo ($document_log->approval_status_out_sub6->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->approval_status_out_sub6->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_approval_status_out_sub6">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_approval_status_out_sub6"><?php echo $document_log->approval_status_out_sub6->caption() ?><?php echo ($document_log->approval_status_out_sub6->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_direction_in_sub6" class="form-group row">
		<label id="elh_document_log_direction_in_sub6" for="x_direction_in_sub6" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->direction_in_sub6->caption() ?><?php echo ($document_log->direction_in_sub6->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->direction_in_sub6->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_direction_in_sub6">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_direction_in_sub6"><?php echo $document_log->direction_in_sub6->caption() ?><?php echo ($document_log->direction_in_sub6->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_transmit_no_in_sub6" class="form-group row">
		<label id="elh_document_log_transmit_no_in_sub6" for="x_transmit_no_in_sub6" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->transmit_no_in_sub6->caption() ?><?php echo ($document_log->transmit_no_in_sub6->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->transmit_no_in_sub6->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_transmit_no_in_sub6">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_transmit_no_in_sub6"><?php echo $document_log->transmit_no_in_sub6->caption() ?><?php echo ($document_log->transmit_no_in_sub6->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_approval_status_in_sub6" class="form-group row">
		<label id="elh_document_log_approval_status_in_sub6" for="x_approval_status_in_sub6" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->approval_status_in_sub6->caption() ?><?php echo ($document_log->approval_status_in_sub6->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->approval_status_in_sub6->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_approval_status_in_sub6">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_approval_status_in_sub6"><?php echo $document_log->approval_status_in_sub6->caption() ?><?php echo ($document_log->approval_status_in_sub6->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_direction_in_file_sub6" class="form-group row">
		<label id="elh_document_log_direction_in_file_sub6" for="x_direction_in_file_sub6" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->direction_in_file_sub6->caption() ?><?php echo ($document_log->direction_in_file_sub6->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->direction_in_file_sub6->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_direction_in_file_sub6">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_direction_in_file_sub6"><?php echo $document_log->direction_in_file_sub6->caption() ?><?php echo ($document_log->direction_in_file_sub6->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_transmit_date_in_sub6" class="form-group row">
		<label id="elh_document_log_transmit_date_in_sub6" for="x_transmit_date_in_sub6" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->transmit_date_in_sub6->caption() ?><?php echo ($document_log->transmit_date_in_sub6->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->transmit_date_in_sub6->cellAttributes() ?>>
...
<script>
ew.createDateTimePicker("fdocument_logedit", "x_transmit_date_in_sub6", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php } else { ?>
	<tr id="r_transmit_date_in_sub6">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_transmit_date_in_sub6"><?php echo $document_log->transmit_date_in_sub6->caption() ?><?php echo ($document_log->transmit_date_in_sub6->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_submit_no_sub7" class="form-group row">
		<label id="elh_document_log_submit_no_sub7" for="x_submit_no_sub7" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->submit_no_sub7->caption() ?><?php echo ($document_log->submit_no_sub7->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->submit_no_sub7->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_submit_no_sub7">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_submit_no_sub7"><?php echo $document_log->submit_no_sub7->caption() ?><?php echo ($document_log->submit_no_sub7->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_revision_no_sub7" class="form-group row">
		<label id="elh_document_log_revision_no_sub7" for="x_revision_no_sub7" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->revision_no_sub7->caption() ?><?php echo ($document_log->revision_no_sub7->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->revision_no_sub7->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_revision_no_sub7">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_revision_no_sub7"><?php echo $document_log->revision_no_sub7->caption() ?><?php echo ($document_log->revision_no_sub7->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_direction_out_sub7" class="form-group row">
		<label id="elh_document_log_direction_out_sub7" for="x_direction_out_sub7" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->direction_out_sub7->caption() ?><?php echo ($document_log->direction_out_sub7->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->direction_out_sub7->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_direction_out_sub7">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_direction_out_sub7"><?php echo $document_log->direction_out_sub7->caption() ?><?php echo ($document_log->direction_out_sub7->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_planned_date_out_sub7" class="form-group row">
		<label id="elh_document_log_planned_date_out_sub7" for="x_planned_date_out_sub7" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->planned_date_out_sub7->caption() ?><?php echo ($document_log->planned_date_out_sub7->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->planned_date_out_sub7->cellAttributes() ?>>
...
<script>
ew.createDateTimePicker("fdocument_logedit", "x_planned_date_out_sub7", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php } else { ?>
	<tr id="r_planned_date_out_sub7">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_planned_date_out_sub7"><?php echo $document_log->planned_date_out_sub7->caption() ?><?php echo ($document_log->planned_date_out_sub7->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_transmit_date_out_sub7" class="form-group row">
		<label id="elh_document_log_transmit_date_out_sub7" for="x_transmit_date_out_sub7" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->transmit_date_out_sub7->caption() ?><?php echo ($document_log->transmit_date_out_sub7->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->transmit_date_out_sub7->cellAttributes() ?>>
...
<script>
ew.createDateTimePicker("fdocument_logedit", "x_transmit_date_out_sub7", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php } else { ?>
	<tr id="r_transmit_date_out_sub7">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_transmit_date_out_sub7"><?php echo $document_log->transmit_date_out_sub7->caption() ?><?php echo ($document_log->transmit_date_out_sub7->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_transmit_no_out_sub7" class="form-group row">
		<label id="elh_document_log_transmit_no_out_sub7" for="x_transmit_no_out_sub7" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->transmit_no_out_sub7->caption() ?><?php echo ($document_log->transmit_no_out_sub7->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->transmit_no_out_sub7->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_transmit_no_out_sub7">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_transmit_no_out_sub7"><?php echo $document_log->transmit_no_out_sub7->caption() ?><?php echo ($document_log->transmit_no_out_sub7->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_approval_status_out_sub7" class="form-group row">
		<label id="elh_document_log_approval_status_out_sub7" for="x_approval_status_out_sub7" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->approval_status_out_sub7->caption() ?><?php echo ($document_log->approval_status_out_sub7->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->approval_status_out_sub7->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_approval_status_out_sub7">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_approval_status_out_sub7"><?php echo $document_log->approval_status_out_sub7->caption() ?><?php echo ($document_log->approval_status_out_sub7->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_direction_in_sub7" class="form-group row">
		<label id="elh_document_log_direction_in_sub7" for="x_direction_in_sub7" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->direction_in_sub7->caption() ?><?php echo ($document_log->direction_in_sub7->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->direction_in_sub7->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_direction_in_sub7">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_direction_in_sub7"><?php echo $document_log->direction_in_sub7->caption() ?><?php echo ($document_log->direction_in_sub7->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_transmit_no_in_sub7" class="form-group row">
		<label id="elh_document_log_transmit_no_in_sub7" for="x_transmit_no_in_sub7" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->transmit_no_in_sub7->caption() ?><?php echo ($document_log->transmit_no_in_sub7->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->transmit_no_in_sub7->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_transmit_no_in_sub7">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_transmit_no_in_sub7"><?php echo $document_log->transmit_no_in_sub7->caption() ?><?php echo ($document_log->transmit_no_in_sub7->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_approval_status_in_sub7" class="form-group row">
		<label id="elh_document_log_approval_status_in_sub7" for="x_approval_status_in_sub7" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->approval_status_in_sub7->caption() ?><?php echo ($document_log->approval_status_in_sub7->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->approval_status_in_sub7->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_approval_status_in_sub7">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_approval_status_in_sub7"><?php echo $document_log->approval_status_in_sub7->caption() ?><?php echo ($document_log->approval_status_in_sub7->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_transmit_date_in_sub7" class="form-group row">
		<label id="elh_document_log_transmit_date_in_sub7" for="x_transmit_date_in_sub7" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->transmit_date_in_sub7->caption() ?><?php echo ($document_log->transmit_date_in_sub7->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->transmit_date_in_sub7->cellAttributes() ?>>
...
<script>
ew.createDateTimePicker("fdocument_logedit", "x_transmit_date_in_sub7", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php } else { ?>
	<tr id="r_transmit_date_in_sub7">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_transmit_date_in_sub7"><?php echo $document_log->transmit_date_in_sub7->caption() ?><?php echo ($document_log->transmit_date_in_sub7->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_submit_no_sub8" class="form-group row">
		<label id="elh_document_log_submit_no_sub8" for="x_submit_no_sub8" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->submit_no_sub8->caption() ?><?php echo ($document_log->submit_no_sub8->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->submit_no_sub8->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_submit_no_sub8">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_submit_no_sub8"><?php echo $document_log->submit_no_sub8->caption() ?><?php echo ($document_log->submit_no_sub8->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_revision_no_sub8" class="form-group row">
		<label id="elh_document_log_revision_no_sub8" for="x_revision_no_sub8" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->revision_no_sub8->caption() ?><?php echo ($document_log->revision_no_sub8->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->revision_no_sub8->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_revision_no_sub8">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_revision_no_sub8"><?php echo $document_log->revision_no_sub8->caption() ?><?php echo ($document_log->revision_no_sub8->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_direction_out_sub8" class="form-group row">
		<label id="elh_document_log_direction_out_sub8" for="x_direction_out_sub8" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->direction_out_sub8->caption() ?><?php echo ($document_log->direction_out_sub8->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->direction_out_sub8->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_direction_out_sub8">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_direction_out_sub8"><?php echo $document_log->direction_out_sub8->caption() ?><?php echo ($document_log->direction_out_sub8->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_planned_date_out_sub8" class="form-group row">
		<label id="elh_document_log_planned_date_out_sub8" for="x_planned_date_out_sub8" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->planned_date_out_sub8->caption() ?><?php echo ($document_log->planned_date_out_sub8->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->planned_date_out_sub8->cellAttributes() ?>>
...
<script>
ew.createDateTimePicker("fdocument_logedit", "x_planned_date_out_sub8", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php } else { ?>
	<tr id="r_planned_date_out_sub8">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_planned_date_out_sub8"><?php echo $document_log->planned_date_out_sub8->caption() ?><?php echo ($document_log->planned_date_out_sub8->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_transmit_date_out_sub8" class="form-group row">
		<label id="elh_document_log_transmit_date_out_sub8" for="x_transmit_date_out_sub8" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->transmit_date_out_sub8->caption() ?><?php echo ($document_log->transmit_date_out_sub8->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->transmit_date_out_sub8->cellAttributes() ?>>
...
<script>
ew.createDateTimePicker("fdocument_logedit", "x_transmit_date_out_sub8", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php } else { ?>
	<tr id="r_transmit_date_out_sub8">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_transmit_date_out_sub8"><?php echo $document_log->transmit_date_out_sub8->caption() ?><?php echo ($document_log->transmit_date_out_sub8->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_transmit_no_out_sub8" class="form-group row">
		<label id="elh_document_log_transmit_no_out_sub8" for="x_transmit_no_out_sub8" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->transmit_no_out_sub8->caption() ?><?php echo ($document_log->transmit_no_out_sub8->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->transmit_no_out_sub8->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_transmit_no_out_sub8">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_transmit_no_out_sub8"><?php echo $document_log->transmit_no_out_sub8->caption() ?><?php echo ($document_log->transmit_no_out_sub8->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_approval_status_out_sub8" class="form-group row">
		<label id="elh_document_log_approval_status_out_sub8" for="x_approval_status_out_sub8" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->approval_status_out_sub8->caption() ?><?php echo ($document_log->approval_status_out_sub8->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->approval_status_out_sub8->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_approval_status_out_sub8">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_approval_status_out_sub8"><?php echo $document_log->approval_status_out_sub8->caption() ?><?php echo ($document_log->approval_status_out_sub8->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_direction_out_file_sub8" class="form-group row">
		<label id="elh_document_log_direction_out_file_sub8" for="x_direction_out_file_sub8" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->direction_out_file_sub8->caption() ?><?php echo ($document_log->direction_out_file_sub8->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->direction_out_file_sub8->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_direction_out_file_sub8">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_direction_out_file_sub8"><?php echo $document_log->direction_out_file_sub8->caption() ?><?php echo ($document_log->direction_out_file_sub8->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_direction_in_sub8" class="form-group row">
		<label id="elh_document_log_direction_in_sub8" for="x_direction_in_sub8" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->direction_in_sub8->caption() ?><?php echo ($document_log->direction_in_sub8->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->direction_in_sub8->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_direction_in_sub8">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_direction_in_sub8"><?php echo $document_log->direction_in_sub8->caption() ?><?php echo ($document_log->direction_in_sub8->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_transmit_no_in_sub8" class="form-group row">
		<label id="elh_document_log_transmit_no_in_sub8" for="x_transmit_no_in_sub8" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->transmit_no_in_sub8->caption() ?><?php echo ($document_log->transmit_no_in_sub8->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->transmit_no_in_sub8->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_transmit_no_in_sub8">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_transmit_no_in_sub8"><?php echo $document_log->transmit_no_in_sub8->caption() ?><?php echo ($document_log->transmit_no_in_sub8->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_approval_status_in_sub8" class="form-group row">
		<label id="elh_document_log_approval_status_in_sub8" for="x_approval_status_in_sub8" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->approval_status_in_sub8->caption() ?><?php echo ($document_log->approval_status_in_sub8->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->approval_status_in_sub8->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_approval_status_in_sub8">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_approval_status_in_sub8"><?php echo $document_log->approval_status_in_sub8->caption() ?><?php echo ($document_log->approval_status_in_sub8->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_transmit_date_in_sub8" class="form-group row">
		<label id="elh_document_log_transmit_date_in_sub8" for="x_transmit_date_in_sub8" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->transmit_date_in_sub8->caption() ?><?php echo ($document_log->transmit_date_in_sub8->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->transmit_date_in_sub8->cellAttributes() ?>>
...
<script>
ew.createDateTimePicker("fdocument_logedit", "x_transmit_date_in_sub8", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php } else { ?>
	<tr id="r_transmit_date_in_sub8">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_transmit_date_in_sub8"><?php echo $document_log->transmit_date_in_sub8->caption() ?><?php echo ($document_log->transmit_date_in_sub8->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_submit_no_sub9" class="form-group row">
		<label id="elh_document_log_submit_no_sub9" for="x_submit_no_sub9" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->submit_no_sub9->caption() ?><?php echo ($document_log->submit_no_sub9->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->submit_no_sub9->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_submit_no_sub9">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_submit_no_sub9"><?php echo $document_log->submit_no_sub9->caption() ?><?php echo ($document_log->submit_no_sub9->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_revision_no_sub9" class="form-group row">
		<label id="elh_document_log_revision_no_sub9" for="x_revision_no_sub9" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->revision_no_sub9->caption() ?><?php echo ($document_log->revision_no_sub9->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->revision_no_sub9->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_revision_no_sub9">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_revision_no_sub9"><?php echo $document_log->revision_no_sub9->caption() ?><?php echo ($document_log->revision_no_sub9->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_direction_out_sub9" class="form-group row">
		<label id="elh_document_log_direction_out_sub9" for="x_direction_out_sub9" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->direction_out_sub9->caption() ?><?php echo ($document_log->direction_out_sub9->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->direction_out_sub9->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_direction_out_sub9">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_direction_out_sub9"><?php echo $document_log->direction_out_sub9->caption() ?><?php echo ($document_log->direction_out_sub9->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_planned_date_out_sub9" class="form-group row">
		<label id="elh_document_log_planned_date_out_sub9" for="x_planned_date_out_sub9" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->planned_date_out_sub9->caption() ?><?php echo ($document_log->planned_date_out_sub9->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->planned_date_out_sub9->cellAttributes() ?>>
...
<script>
ew.createDateTimePicker("fdocument_logedit", "x_planned_date_out_sub9", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php } else { ?>
	<tr id="r_planned_date_out_sub9">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_planned_date_out_sub9"><?php echo $document_log->planned_date_out_sub9->caption() ?><?php echo ($document_log->planned_date_out_sub9->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_transmit_date_out_sub9" class="form-group row">
		<label id="elh_document_log_transmit_date_out_sub9" for="x_transmit_date_out_sub9" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->transmit_date_out_sub9->caption() ?><?php echo ($document_log->transmit_date_out_sub9->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->transmit_date_out_sub9->cellAttributes() ?>>
...
<script>
ew.createDateTimePicker("fdocument_logedit", "x_transmit_date_out_sub9", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php } else { ?>
	<tr id="r_transmit_date_out_sub9">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_transmit_date_out_sub9"><?php echo $document_log->transmit_date_out_sub9->caption() ?><?php echo ($document_log->transmit_date_out_sub9->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_transmit_no_out_sub9" class="form-group row">
		<label id="elh_document_log_transmit_no_out_sub9" for="x_transmit_no_out_sub9" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->transmit_no_out_sub9->caption() ?><?php echo ($document_log->transmit_no_out_sub9->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->transmit_no_out_sub9->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_transmit_no_out_sub9">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_transmit_no_out_sub9"><?php echo $document_log->transmit_no_out_sub9->caption() ?><?php echo ($document_log->transmit_no_out_sub9->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_approval_status_out_sub9" class="form-group row">
		<label id="elh_document_log_approval_status_out_sub9" for="x_approval_status_out_sub9" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->approval_status_out_sub9->caption() ?><?php echo ($document_log->approval_status_out_sub9->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->approval_status_out_sub9->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_approval_status_out_sub9">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_approval_status_out_sub9"><?php echo $document_log->approval_status_out_sub9->caption() ?><?php echo ($document_log->approval_status_out_sub9->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_direction_in_sub9" class="form-group row">
		<label id="elh_document_log_direction_in_sub9" for="x_direction_in_sub9" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->direction_in_sub9->caption() ?><?php echo ($document_log->direction_in_sub9->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->direction_in_sub9->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_direction_in_sub9">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_direction_in_sub9"><?php echo $document_log->direction_in_sub9->caption() ?><?php echo ($document_log->direction_in_sub9->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_transmit_no_in_sub9" class="form-group row">
		<label id="elh_document_log_transmit_no_in_sub9" for="x_transmit_no_in_sub9" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->transmit_no_in_sub9->caption() ?><?php echo ($document_log->transmit_no_in_sub9->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->transmit_no_in_sub9->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_transmit_no_in_sub9">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_transmit_no_in_sub9"><?php echo $document_log->transmit_no_in_sub9->caption() ?><?php echo ($document_log->transmit_no_in_sub9->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_approval_status_in_sub9" class="form-group row">
		<label id="elh_document_log_approval_status_in_sub9" for="x_approval_status_in_sub9" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->approval_status_in_sub9->caption() ?><?php echo ($document_log->approval_status_in_sub9->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->approval_status_in_sub9->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_approval_status_in_sub9">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_approval_status_in_sub9"><?php echo $document_log->approval_status_in_sub9->caption() ?><?php echo ($document_log->approval_status_in_sub9->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_transmit_date_in_sub9" class="form-group row">
		<label id="elh_document_log_transmit_date_in_sub9" for="x_transmit_date_in_sub9" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->transmit_date_in_sub9->caption() ?><?php echo ($document_log->transmit_date_in_sub9->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->transmit_date_in_sub9->cellAttributes() ?>>
...
<script>
ew.createDateTimePicker("fdocument_logedit", "x_transmit_date_in_sub9", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php } else { ?>
	<tr id="r_transmit_date_in_sub9">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_transmit_date_in_sub9"><?php echo $document_log->transmit_date_in_sub9->caption() ?><?php echo ($document_log->transmit_date_in_sub9->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_submit_no_sub10" class="form-group row">
		<label id="elh_document_log_submit_no_sub10" for="x_submit_no_sub10" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->submit_no_sub10->caption() ?><?php echo ($document_log->submit_no_sub10->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->submit_no_sub10->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_submit_no_sub10">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_submit_no_sub10"><?php echo $document_log->submit_no_sub10->caption() ?><?php echo ($document_log->submit_no_sub10->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_revision_no_sub10" class="form-group row">
		<label id="elh_document_log_revision_no_sub10" for="x_revision_no_sub10" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->revision_no_sub10->caption() ?><?php echo ($document_log->revision_no_sub10->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->revision_no_sub10->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_revision_no_sub10">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_revision_no_sub10"><?php echo $document_log->revision_no_sub10->caption() ?><?php echo ($document_log->revision_no_sub10->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_direction_out_sub10" class="form-group row">
		<label id="elh_document_log_direction_out_sub10" for="x_direction_out_sub10" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->direction_out_sub10->caption() ?><?php echo ($document_log->direction_out_sub10->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->direction_out_sub10->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_direction_out_sub10">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_direction_out_sub10"><?php echo $document_log->direction_out_sub10->caption() ?><?php echo ($document_log->direction_out_sub10->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_planned_date_out_sub10" class="form-group row">
		<label id="elh_document_log_planned_date_out_sub10" for="x_planned_date_out_sub10" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->planned_date_out_sub10->caption() ?><?php echo ($document_log->planned_date_out_sub10->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->planned_date_out_sub10->cellAttributes() ?>>
...
<script>
ew.createDateTimePicker("fdocument_logedit", "x_planned_date_out_sub10", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php } else { ?>
	<tr id="r_planned_date_out_sub10">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_planned_date_out_sub10"><?php echo $document_log->planned_date_out_sub10->caption() ?><?php echo ($document_log->planned_date_out_sub10->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_transmit_date_out_sub10" class="form-group row">
		<label id="elh_document_log_transmit_date_out_sub10" for="x_transmit_date_out_sub10" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->transmit_date_out_sub10->caption() ?><?php echo ($document_log->transmit_date_out_sub10->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->transmit_date_out_sub10->cellAttributes() ?>>
...
<script>
ew.createDateTimePicker("fdocument_logedit", "x_transmit_date_out_sub10", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php } else { ?>
	<tr id="r_transmit_date_out_sub10">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_transmit_date_out_sub10"><?php echo $document_log->transmit_date_out_sub10->caption() ?><?php echo ($document_log->transmit_date_out_sub10->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_transmit_no_out_sub10" class="form-group row">
		<label id="elh_document_log_transmit_no_out_sub10" for="x_transmit_no_out_sub10" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->transmit_no_out_sub10->caption() ?><?php echo ($document_log->transmit_no_out_sub10->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->transmit_no_out_sub10->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_transmit_no_out_sub10">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_transmit_no_out_sub10"><?php echo $document_log->transmit_no_out_sub10->caption() ?><?php echo ($document_log->transmit_no_out_sub10->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_approval_status_out_sub10" class="form-group row">
		<label id="elh_document_log_approval_status_out_sub10" for="x_approval_status_out_sub10" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->approval_status_out_sub10->caption() ?><?php echo ($document_log->approval_status_out_sub10->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->approval_status_out_sub10->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_approval_status_out_sub10">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_approval_status_out_sub10"><?php echo $document_log->approval_status_out_sub10->caption() ?><?php echo ($document_log->approval_status_out_sub10->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_direction_in_sub10" class="form-group row">
		<label id="elh_document_log_direction_in_sub10" for="x_direction_in_sub10" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->direction_in_sub10->caption() ?><?php echo ($document_log->direction_in_sub10->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->direction_in_sub10->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_direction_in_sub10">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_direction_in_sub10"><?php echo $document_log->direction_in_sub10->caption() ?><?php echo ($document_log->direction_in_sub10->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_transmit_no_in_sub10" class="form-group row">
		<label id="elh_document_log_transmit_no_in_sub10" for="x_transmit_no_in_sub10" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->transmit_no_in_sub10->caption() ?><?php echo ($document_log->transmit_no_in_sub10->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->transmit_no_in_sub10->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_transmit_no_in_sub10">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_transmit_no_in_sub10"><?php echo $document_log->transmit_no_in_sub10->caption() ?><?php echo ($document_log->transmit_no_in_sub10->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_approval_status_in_sub10" class="form-group row">
		<label id="elh_document_log_approval_status_in_sub10" for="x_approval_status_in_sub10" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->approval_status_in_sub10->caption() ?><?php echo ($document_log->approval_status_in_sub10->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->approval_status_in_sub10->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_approval_status_in_sub10">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_approval_status_in_sub10"><?php echo $document_log->approval_status_in_sub10->caption() ?><?php echo ($document_log->approval_status_in_sub10->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($document_log_edit->IsMobileOrModal) { ?>
	<div id="r_transmit_date_in_sub10" class="form-group row">
		<label id="elh_document_log_transmit_date_in_sub10" for="x_transmit_date_in_sub10" class="<?php echo $document_log_edit->LeftColumnClass ?>"><?php echo $document_log->transmit_date_in_sub10->caption() ?><?php echo ($document_log->transmit_date_in_sub10->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $document_log_edit->RightColumnClass ?>"><div<?php echo $document_log->transmit_date_in_sub10->cellAttributes() ?>>
...
<script>
ew.createDateTimePicker("fdocument_logedit", "x_transmit_date_in_sub10", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php } else { ?>
	<tr id="r_transmit_date_in_sub10">
		<td class="<?php echo $document_log_edit->TableLeftColumnClass ?>"><span id="elh_document_log_transmit_date_in_sub10"><?php echo $document_log->transmit_date_in_sub10->caption() ?><?php echo ($document_log->transmit_date_in_sub10->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
