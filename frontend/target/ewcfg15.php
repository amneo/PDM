...
define(PROJECT_NAMESPACE . "RANDOM_KEY", 'tsi9zZKZ9t3auMwF'); // Random key for encryption
...
define(PROJECT_NAMESPACE . "ADMIN_USER_NAME", "root"); // Administrator user name
define(PROJECT_NAMESPACE . "ADMIN_PASSWORD", "wakarewara11"); // Administrator password
...
define(PROJECT_NAMESPACE . "AUTO_HIDE_PAGE_SIZE_SELECTOR", TRUE);
