...
fapproval_detailsedit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php } ?>
		<?php if ($approval_details_edit->out_status->Required) { ?>
		...
		<?php } ?>
		<?php if ($approval_details_edit->in_status->Required) { ?>
...
<?php if ($approval_details_edit->IsMobileOrModal) { ?>
	<div id="r_out_status" class="form-group row">
		<label id="elh_approval_details_out_status" for="x_out_status" class="<?php echo $approval_details_edit->LeftColumnClass ?>"><?php echo $approval_details->out_status->caption() ?><?php echo ($approval_details->out_status->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $approval_details_edit->RightColumnClass ?>"><div<?php echo $approval_details->out_status->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_out_status">
		<td class="<?php echo $approval_details_edit->TableLeftColumnClass ?>"><span id="elh_approval_details_out_status"><?php echo $approval_details->out_status->caption() ?><?php echo ($approval_details->out_status->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($approval_details_edit->IsMobileOrModal) { ?>
	<div id="r_in_status" class="form-group row">
		<label id="elh_approval_details_in_status" for="x_in_status" class="<?php echo $approval_details_edit->LeftColumnClass ?>"><?php echo $approval_details->in_status->caption() ?><?php echo ($approval_details->in_status->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $approval_details_edit->RightColumnClass ?>"><div<?php echo $approval_details->in_status->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_in_status">
		<td class="<?php echo $approval_details_edit->TableLeftColumnClass ?>"><span id="elh_approval_details_in_status"><?php echo $approval_details->in_status->caption() ?><?php echo ($approval_details->in_status->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
