 ...
 * Page class
 */
class project_details_view extends project_details
{
	...
	// Page object name
	public $PageObjName = "project_details_view";
	...
	public function __construct()
	{
		...
		if (Get("project_id") !== NULL) {
			$this->RecKey["project_id"] = Get("project_id");
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("project_id") !== NULL) {
				...
				$this->project_id->setQueryStringValue(Key(0));
				$this->RecKey["project_id"] = $this->project_id->QueryStringValue;
			} elseif (Post("project_id") !== NULL) {
				$this->project_id->setFormValue(Post("project_id"));
				$this->RecKey["project_id"] = $this->project_id->FormValue;
			} elseif (IsApi() && Route(2) != NULL) {
				$this->project_id->setFormValue(Route(2));
				$this->RecKey["project_id"] = $this->project_id->FormValue;
			} else {
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if ($this->TotalRecs <= 0) { // No record found
						...
						$this->terminate("project_detailslist.php"); // Return to list page
						...
						while (!$this->Recordset->EOF) {
							if (SameString($this->project_id->CurrentValue, $this->Recordset->fields('project_id'))) {
					...
					if (!$matchRecord) {
						if ($this->getSuccessMessage() == "" && $this->getFailureMessage() == "")
							$this->setFailureMessage($Language->phrase("NoRecord")); // Set no record message
						$returnUrl = "project_detailslist.php"; // No matching record, return to list
					} else {
			...
			$returnUrl = "project_detailslist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "") {
	...
	protected function getExportTag($type, $custom = FALSE)
	{
		...
		if (SameText($type, "excel")) {
			if ($custom)
				return "<a href=\"javascript:void(0);\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"ew.export(document.fproject_detailsview,'" . $this->ExportExcelUrl . "','excel',true);\">" . $Language->phrase("ExportToExcel") . "</a>";
			else
				return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
		} elseif (SameText($type, "word")) {
			if ($custom)
				return "<a href=\"javascript:void(0);\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"ew.export(document.fproject_detailsview,'" . $this->ExportWordUrl . "','word',true);\">" . $Language->phrase("ExportToWord") . "</a>";
			else
				return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
		} elseif (SameText($type, "pdf")) {
			if ($custom)
				return "<a href=\"javascript:void(0);\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"ew.export(document.fproject_detailsview,'" . $this->ExportPdfUrl . "','pdf',true);\">" . $Language->phrase("ExportToPDF") . "</a>";
			else
