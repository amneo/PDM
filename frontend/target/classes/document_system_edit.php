 ...
 * Page class
 */
class document_system_edit extends document_system
{
	...
	// Page object name
	public $PageObjName = "document_system_edit";
		...
		switch ($this->CurrentAction) {
			case "show": // Get a record to display
				if (!$loaded) { // Load record based on key
					...
					$this->terminate("document_systemlist.php"); // No matching record, return to list
				}
				break;
			case "update": // Update
				$returnUrl = $this->getReturnUrl();
				if (GetPageName($returnUrl) == "document_systemlist.php")
