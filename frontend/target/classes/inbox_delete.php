 ...
 * Page class
 */
class inbox_delete extends inbox
{
	...
	// Page object name
	public $PageObjName = "inbox_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("inboxlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("inboxlist.php"); // Return to list
			}
		}
	}
