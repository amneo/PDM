 ...
 * Page class
 */
class project_details_addopt extends project_details
{
	...
	// Page object name
	public $PageObjName = "project_details_addopt";
	...
	protected function loadFormValues()
	{
		...
		if (!$this->project_our_client->IsDetailKey) {
			$this->project_our_client->setFormValue(ConvertFromUtf8($val));
		}
		...
		if (!$this->project_end_user->IsDetailKey) {
			$this->project_end_user->setFormValue(ConvertFromUtf8($val));
		}
		...
		if (!$this->project_sales_engg->IsDetailKey) {
			$this->project_sales_engg->setFormValue(ConvertFromUtf8($val));
		}
		...
		if (!$this->project_distribution->IsDetailKey) {
			$this->project_distribution->setFormValue(ConvertFromUtf8($val));
		}
		...
		if (!$this->project_transmittal->IsDetailKey) {
			$this->project_transmittal->setFormValue(ConvertFromUtf8($val));
		}
	...
	public function restoreFormValues()
	{
		...
		$this->project_our_client->CurrentValue = ConvertToUtf8($this->project_our_client->FormValue);
		$this->project_end_user->CurrentValue = ConvertToUtf8($this->project_end_user->FormValue);
		$this->project_sales_engg->CurrentValue = ConvertToUtf8($this->project_sales_engg->FormValue);
		$this->project_distribution->CurrentValue = ConvertToUtf8($this->project_distribution->FormValue);
		$this->project_transmittal->CurrentValue = ConvertToUtf8($this->project_transmittal->FormValue);
		$this->order_number->CurrentValue = ConvertToUtf8($this->order_number->FormValue);
	}
