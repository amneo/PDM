...
class userlevelpermissions extends DbTable
{
	...
	public function __construct()
	{
		...
		// Update Table
		$this->UpdateTable = "\"public\".\"userlevelpermissions\"";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// userlevelid
		$this->userlevelid = new DbField('userlevelpermissions', 'userlevelpermissions', 'x_userlevelid', 'userlevelid', '"userlevelid"', 'CAST("userlevelid" AS varchar(255))', 3, -1, FALSE, '"userlevelid"', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tablename
		$this->_tablename = new DbField('userlevelpermissions', 'userlevelpermissions', 'x__tablename', 'tablename', '"tablename"', '"tablename"', 200, -1, FALSE, '"tablename"', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->_tablename->UsePleaseSelect = TRUE; // Use PleaseSelect by default
		$this->_tablename->PleaseSelectText = $Language->phrase("PleaseSelect"); // PleaseSelect text
		...
		// permission
		$this->permission = new DbField('userlevelpermissions', 'userlevelpermissions', 'x_permission', 'permission', '"permission"', 'CAST("permission" AS varchar(255))', 3, -1, FALSE, '"permission"', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom <> "") ? $this->SqlFrom : "\"public\".\"userlevelpermissions\"";
	}
