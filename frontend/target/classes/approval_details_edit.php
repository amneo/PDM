 ...
 * Page class
 */
class approval_details_edit extends approval_details
{
	...
	// Page object name
	public $PageObjName = "approval_details_edit";
		...
		switch ($this->CurrentAction) {
			case "show": // Get a record to display
				if (!$loaded) { // Load record based on key
					...
					$this->terminate("approval_detailslist.php"); // No matching record, return to list
				}
				break;
			case "update": // Update
				$returnUrl = $this->getReturnUrl();
				if (GetPageName($returnUrl) == "approval_detailslist.php")
