 ...
 * Page class
 */
class distribution_details_delete extends distribution_details
{
	...
	// Page object name
	public $PageObjName = "distribution_details_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("distribution_detailslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("distribution_detailslist.php"); // Return to list
			}
		}
	}
