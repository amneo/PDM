 ...
 * Page class
 */
class xmit_details_delete extends xmit_details
{
	...
	// Page object name
	public $PageObjName = "xmit_details_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("xmit_detailslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("xmit_detailslist.php"); // Return to list
			}
		}
	}
