 ...
 * Page class
 */
class transmit_details_view extends transmit_details
{
	...
	// Page object name
	public $PageObjName = "transmit_details_view";
	...
	public function __construct()
	{
		...
		if (Get("transmit_id") !== NULL) {
			$this->RecKey["transmit_id"] = Get("transmit_id");
			$keyUrl .= "&amp;transmit_id=" . urlencode($this->RecKey["transmit_id"]);
		}
	...
	public function run()
	{
		...
		if (Get("transmit_id") !== NULL) {
			if ($ExportFileName <> "")
				$ExportFileName .= "_";
			$ExportFileName .= Get("transmit_id");
		}
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("transmit_id") !== NULL) {
				...
				$this->RecKey["transmit_id"] = $this->transmit_id->QueryStringValue;
			} elseif (IsApi() && Key(0) != NULL) {
				$this->transmit_id->setQueryStringValue(Key(0));
				$this->RecKey["transmit_id"] = $this->transmit_id->QueryStringValue;
			} elseif (Post("transmit_id") !== NULL) {
				$this->transmit_id->setFormValue(Post("transmit_id"));
			...
			$returnUrl = "transmit_detailslist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "") {
	...
	protected function getExportTag($type, $custom = FALSE)
	{
		...
		if (SameText($type, "excel")) {
			if ($custom)
				return "<a href=\"javascript:void(0);\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"ew.export(document.ftransmit_detailsview,'" . $this->ExportExcelUrl . "','excel',true);\">" . $Language->phrase("ExportToExcel") . "</a>";
			else
				return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
		} elseif (SameText($type, "word")) {
			if ($custom)
				return "<a href=\"javascript:void(0);\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"ew.export(document.ftransmit_detailsview,'" . $this->ExportWordUrl . "','word',true);\">" . $Language->phrase("ExportToWord") . "</a>";
			else
				return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
		} elseif (SameText($type, "pdf")) {
			if ($custom)
				return "<a href=\"javascript:void(0);\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"ew.export(document.ftransmit_detailsview,'" . $this->ExportPdfUrl . "','pdf',true);\">" . $Language->phrase("ExportToPDF") . "</a>";
			else
