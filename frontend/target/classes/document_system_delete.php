 ...
 * Page class
 */
class document_system_delete extends document_system
{
	...
	// Page object name
	public $PageObjName = "document_system_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("document_systemlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("document_systemlist.php"); // Return to list
			}
		}
	}
