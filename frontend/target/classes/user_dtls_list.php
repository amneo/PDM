 ...
 * Page class
 */
class user_dtls_list extends user_dtls
{
	...
	// Page object name
	public $PageObjName = "user_dtls_list";

	// Grid form hidden field names
	public $FormName = "fuser_dtlslist";
	...
	public function __construct()
	{
		...
		$this->AddUrl = "user_dtlsadd.php";
		$this->InlineAddUrl = $this->pageUrl() . "action=add";
		$this->GridAddUrl = $this->pageUrl() . "action=gridadd";
		$this->GridEditUrl = $this->pageUrl() . "action=gridedit";
		$this->MultiDeleteUrl = "user_dtlsdelete.php";
		$this->MultiUpdateUrl = "user_dtlsupdate.php";
		...
		$this->FilterOptions->TagClassName = "ew-filter-option fuser_dtlslistsrch";
	...
	protected function setupKeyValues($key)
	{
		...
		if (count($arKeyFlds) >= 1) {
			$this->user_id->setFormValue($arKeyFlds[0]);
	...
	public function getFilterList()
	{
		...
		$filterList = Concat($filterList, $this->create_login->AdvancedSearch->toJson(), ","); // Field create_login
		$filterList = Concat($filterList, $this->account_valid->AdvancedSearch->toJson(), ","); // Field account_valid
	...
	protected function processFilterList()
	{
		...
		if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
			...
			$UserProfile->setSearchFilters(CurrentUserName(), "fuser_dtlslistsrch", $filters);
	...
	protected function restoreFilterList()
	{
		...
		// Field create_login
		$this->create_login->AdvancedSearch->SearchValue = @$filter["x_create_login"];
		$this->create_login->AdvancedSearch->SearchOperator = @$filter["z_create_login"];
		$this->create_login->AdvancedSearch->SearchCondition = @$filter["v_create_login"];
		$this->create_login->AdvancedSearch->SearchValue2 = @$filter["y_create_login"];
		$this->create_login->AdvancedSearch->SearchOperator2 = @$filter["w_create_login"];
		$this->create_login->AdvancedSearch->save();

		// Field account_valid
		$this->account_valid->AdvancedSearch->SearchValue = @$filter["x_account_valid"];
		$this->account_valid->AdvancedSearch->SearchOperator = @$filter["z_account_valid"];
		$this->account_valid->AdvancedSearch->SearchCondition = @$filter["v_account_valid"];
		$this->account_valid->AdvancedSearch->SearchValue2 = @$filter["y_account_valid"];
		$this->account_valid->AdvancedSearch->SearchOperator2 = @$filter["w_account_valid"];
		$this->account_valid->AdvancedSearch->save();
		...
		$this->email_addreess->AdvancedSearch->SearchValue = @$filter["x_email_addreess"];
		$this->email_addreess->AdvancedSearch->SearchOperator = @$filter["z_email_addreess"];
		$this->email_addreess->AdvancedSearch->SearchCondition = @$filter["v_email_addreess"];
		$this->email_addreess->AdvancedSearch->SearchValue2 = @$filter["y_email_addreess"];
		$this->email_addreess->AdvancedSearch->SearchOperator2 = @$filter["w_email_addreess"];
		$this->email_addreess->AdvancedSearch->save();
	...
	public function renderListOptions()
	{
		...
		if ($Security->canAdd() && $this->showOptionLink('add')) {
			if (IsMobile())
				...
				$opt->Body = "<a class=\"ew-row-link ew-copy\" title=\"" . $copycaption . "\" data-table=\"user_dtls\" data-caption=\"" . $copycaption . "\" href=\"javascript:void(0);\" onclick=\"ew.modalDialogShow({lnk:this,btn:'AddBtn',url:'" . HtmlEncode($this->CopyUrl) . "'});\">" . $Language->phrase("CopyLink") . "</a>";
		} else {
			$opt->Body = "";
		}
		...
		$opt->Body = "<input type=\"checkbox\" name=\"key_m[]\" class=\"ew-multi-select\" value=\"" . HtmlEncode($this->user_id->CurrentValue) . "\" onclick=\"ew.clickMultiCheckbox(event);\">";
	...
	protected function setupOtherOptions()
	{
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"fuser_dtlslistsrch\" href=\"#\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"fuser_dtlslistsrch\" href=\"#\">" . $Language->phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"\" onclick=\"ew.submitAction(event,jQuery.extend({f:document.fuser_dtlslist}," . $listaction->toJson(TRUE) . "));return false;\">" . $icon . "</a>";
	...
	protected function setupSearchOptions()
	{
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fuser_dtlslistsrch\">" . $Language->phrase("SearchLink") . "</button>";
		$item->Visible = TRUE;
	...
	protected function newRow()
	{
		...
		$row['username'] = NULL;
		$row['password'] = NULL;
		$row['create_login'] = NULL;
		$row['account_valid'] = NULL;
		$row['last_login'] = NULL;
	...
	protected function getExportTag($type, $custom = FALSE)
	{
		...
		if (SameText($type, "excel")) {
			if ($custom)
				return "<a href=\"javascript:void(0);\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"ew.export(document.fuser_dtlslist,'" . $this->ExportExcelUrl . "','excel',true);\">" . $Language->phrase("ExportToExcel") . "</a>";
			else
				return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
		} elseif (SameText($type, "word")) {
			if ($custom)
				return "<a href=\"javascript:void(0);\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"ew.export(document.fuser_dtlslist,'" . $this->ExportWordUrl . "','word',true);\">" . $Language->phrase("ExportToWord") . "</a>";
			else
				return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
		} elseif (SameText($type, "pdf")) {
			if ($custom)
				return "<a href=\"javascript:void(0);\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"ew.export(document.fuser_dtlslist,'" . $this->ExportPdfUrl . "','pdf',true);\">" . $Language->phrase("ExportToPDF") . "</a>";
			else
	...
	protected function setupExportOptions()
	{
		...
		$url = "";
		$item->Body = "<button id=\"emf_user_dtls\" class=\"ew-export-link ew-email\" title=\"" . $Language->phrase("ExportToEmailText") . "\" data-caption=\"" . $Language->phrase("ExportToEmailText") . "\" onclick=\"ew.emailDialogShow({lnk:'emf_user_dtls',hdr:ew.language.phrase('ExportToEmailText'),f:document.fuser_dtlslist,sel:false" . $url . "});\">" . $Language->phrase("ExportToEmail") . "</button>";
		$item->Visible = TRUE;
