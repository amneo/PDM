 ...
 * Page class
 */
class document_details_delete extends document_details
{
	...
	// Page object name
	public $PageObjName = "document_details_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("document_detailslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("document_detailslist.php"); // Return to list
			}
		}
	}
