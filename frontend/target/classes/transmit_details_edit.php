 ...
 * Page class
 */
class transmit_details_edit extends transmit_details
{
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			// Load key from Form
			if ($CurrentForm->hasValue("x_transmit_id")) {
				$this->transmit_id->setFormValue($CurrentForm->getValue("x_transmit_id"));
			}
		} else {
