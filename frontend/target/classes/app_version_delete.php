 ...
 * Page class
 */
class app_version_delete extends app_version
{
	...
	// Page object name
	public $PageObjName = "app_version_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("app_versionlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("app_versionlist.php"); // Return to list
			}
		}
	}
