 ...
 * Page class
 */
class transmit_details_delete extends transmit_details
{
	...
	// Page object name
	public $PageObjName = "transmit_details_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("transmit_detailslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("transmit_detailslist.php"); // Return to list
			}
		}
	}
