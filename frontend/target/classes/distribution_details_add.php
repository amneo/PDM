 ...
 * Page class
 */
class distribution_details_add extends distribution_details
{
	...
	// Page object name
	public $PageObjName = "distribution_details_add";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("distribution_id") !== NULL) {
				...
				$this->setKey("distribution_id", $this->distribution_id->CurrentValue); // Set up key
			} else {
				$this->setKey("distribution_id", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "distribution_detailsview.php")
