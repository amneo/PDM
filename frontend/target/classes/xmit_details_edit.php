 ...
 * Page class
 */
class xmit_details_edit extends xmit_details
{
	...
	// Page object name
	public $PageObjName = "xmit_details_edit";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			// Load key from Form
			if ($CurrentForm->hasValue("x_xmit_id")) {
				$this->xmit_id->setFormValue($CurrentForm->getValue("x_xmit_id"));
			}
		} else {
