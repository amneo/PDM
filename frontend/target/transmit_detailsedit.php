...
ftransmit_detailsedit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($transmit_details_edit->transmittal_no->Required) { ?>
		...
		<?php } ?>
		<?php if ($transmit_details_edit->transmit_mode->Required) { ?>
...
ftransmit_detailsedit.lists["x_transmit_mode[]"] = <?php echo $transmit_details_edit->transmit_mode->Lookup->toClientList() ?>;
ftransmit_detailsedit.lists["x_transmit_mode[]"].options = <?php echo JsonEncode($transmit_details_edit->transmit_mode->lookupOptions()) ?>;
...
<?php if ($transmit_details_edit->IsMobileOrModal) { ?>
	<div id="r_transmittal_no" class="form-group row">
		<label id="elh_transmit_details_transmittal_no" for="x_transmittal_no" class="<?php echo $transmit_details_edit->LeftColumnClass ?>"><?php echo $transmit_details->transmittal_no->caption() ?><?php echo ($transmit_details->transmittal_no->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $transmit_details_edit->RightColumnClass ?>"><div<?php echo $transmit_details->transmittal_no->cellAttributes() ?>>
...
<input type="hidden" data-table="transmit_details" data-field="x_transmittal_no" name="x_transmittal_no" id="x_transmittal_no" value="<?php echo HtmlEncode($transmit_details->transmittal_no->CurrentValue) ?>">
<?php } else { ?>
<span id="el_transmit_details_transmittal_no">
<span<?php echo $transmit_details->transmittal_no->viewAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_transmittal_no">
		<td class="<?php echo $transmit_details_edit->TableLeftColumnClass ?>"><span id="elh_transmit_details_transmittal_no"><?php echo $transmit_details->transmittal_no->caption() ?><?php echo ($transmit_details->transmittal_no->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<input type="hidden" data-table="transmit_details" data-field="x_project_name" name="x_project_name" id="x_project_name" value="<?php echo HtmlEncode($transmit_details->project_name->CurrentValue) ?>">
<?php } else { ?>
<span id="el_transmit_details_project_name">
<span<?php echo $transmit_details->project_name->viewAttributes() ?>>
...
<?php if ($transmit_details_edit->IsMobileOrModal) { ?>
	<div id="r_transmit_mode" class="form-group row">
		<label id="elh_transmit_details_transmit_mode" class="<?php echo $transmit_details_edit->LeftColumnClass ?>"><?php echo $transmit_details->transmit_mode->caption() ?><?php echo ($transmit_details->transmit_mode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $transmit_details_edit->RightColumnClass ?>"><div<?php echo $transmit_details->transmit_mode->cellAttributes() ?>>
<?php if (!$transmit_details->isConfirm()) { ?>
...
<?php } else { ?>
	<tr id="r_transmit_mode">
		<td class="<?php echo $transmit_details_edit->TableLeftColumnClass ?>"><span id="elh_transmit_details_transmit_mode"><?php echo $transmit_details->transmit_mode->caption() ?><?php echo ($transmit_details->transmit_mode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
